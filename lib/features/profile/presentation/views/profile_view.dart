                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: GoogleFonts.splineSans(
                        color: ProfileView._textPrimary,
                        fontSize: 18.sp,
    ...
    return SizedBox(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: onTap,
          child: Icon(icon, color: ProfileView._textPrimary, size: 18.sp),
        ),
      ),
    );
  }
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: kButtonsColor,
                    shape: BoxShape.circle,
                    border: Border.all(color: ProfileView._backgroundColor, width: 3),
                  ),
                  child: Icon(Icons.edit, color: const Color(0xFF0E1015), size: 13.sp),
                ),
              ),
            ],
          ),
...
class _StatsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(child: _StatCard(value: '128', label: 'Posts')),
          SizedBox(width: 12.w),
          Expanded(child: _StatCard(value: '2.4k', label: 'Followers')),
          SizedBox(width: 12.w),
          Expanded(child: _StatCard(value: '150', label: 'Following')),
        ],
      ),
    );
  }
